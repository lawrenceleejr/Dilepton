...
bool ZeroLeptonCRZ::processEvent(xAOD::TEvent& event)
{
  ...
  */
  ...
  if (good_jets.size()<2) return true;  
  ...
  if(m_doSmallNtuple) { 
    ...
    Ap = (leptonTLVs[0]+leptonTLVs[1]+good_jets[0]+good_jets[1]).M();
